package com.melihozdemir.yemektarifleri
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (gelenBilgi.equals("menudengeldim")){
                //yeni bir yemek ekemeleye geldi
                ...
                //daha önce oluşturulan yemeği görüntülemeye geldi
    ...
    fun kaydet(view: View){
        ...
        // Byte dizilerini veriye çevirme kodu.
        if (secilenBitmap != null){
            ...
            // veri tabanı kaydetme işlemleri
    ...
    fun gorselSec(view: View){
        ...
        activity?.let {
            ...
            if (ContextCompat.checkSelfPermission(it.applicationContext, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED ){
                //izin verildi mi verilmedi mi?
                requestPermissions(arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE), 1)

            }
            else{
                // Izin verildiyse eğer tekrar izin istemeden galeriye git
    ...
    //Her Türlü Projede Görseli Küçültmek İçin Kullanılan Fonksiyon
